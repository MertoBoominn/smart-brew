    ...
    >
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <button 
          ...
          className="w-12 h-12 rounded-full border border-coffee-border flex items-center justify-center text-white/70 hover:text-coffee-accent hover:border-coffee-accent hover:bg-coffee-accent/10 transition-all duration-300 group-hover:scale-105"
